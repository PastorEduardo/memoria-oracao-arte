...
const BenefitsSection = () => {
  return <section id="beneficios" className="py-16 sm:py-24 bg-gradient-section scroll-mt-20">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8">
          ...
          <Card className="border-none shadow-soft hover:shadow-medium transition-all duration-300 bg-card/80 backdrop-blur-sm">
            <CardContent className="p-4 sm:p-6 md:p-8 text-center">
              ...
              <p className="text-sm sm:text-base text-muted-foreground leading-relaxed">Belas ilustrações para encantar e cativar a atenção das crianças. Sem excessos ou hiperestímulos.</p>
            </CardContent>
          </Card>
