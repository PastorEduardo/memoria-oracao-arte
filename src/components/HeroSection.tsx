...
const HeroSection = () => {
  ...
  return <section className="relative min-h-screen flex items-center justify-center bg-cover bg-center bg-no-repeat pt-16 sm:pt-20" style={{
    backgroundImage: `url(${heroBackground})`
      ...
      <div className="relative z-10 max-w-7xl mx-auto sm:px-6 px-[16px] py-8 sm:py-12">
        {/* Hero Content Grid */}
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-stretch">
          ...
          <div className="flex flex-col justify-center text-center lg:text-left">
            ...
            <div className="mb-6 sm:mb-8 flex justify-center lg:justify-center">
              <img src={logoVertical} alt="Memoria & Oração" className="h-40 sm:h-24 md:h-28" />
            </div>
            {/* Headline */}
            <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-serif font-bold bg-gradient-to-br from-primary via-golden to-spiritual bg-clip-text text-transparent leading-tight mb-4 sm:mb-6">
              Formação cristã dos seus filhos começa com a memorização das
              Escrituras
            </h1>

            {/* Subheadline */}
            <h2 className="text-lg sm:text-xl md:text-2xl text-primary/80 mb-4 sm:mb-6 font-medium leading-relaxed">
              A coleção <strong>Memória & Oração</strong> apoia pais cristãos no
              ensino das virtudes da fé, tornando a memorização bíblica simples,
              bela e significativa.
            </h2>

            {/* Text Body */}
            <p className="text-base sm:text-lg text-muted-foreground mb-8 sm:mb-12 leading-relaxed">
              São <strong>14 livros digitais em PDF</strong>, ilustrados em
              aquarela, prontos para imprimir em casa e usar no devocional da
              família — despertando nas crianças o amor pela Palavra de Deus.
            </p>
